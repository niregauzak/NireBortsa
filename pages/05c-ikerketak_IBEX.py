...
sectors = {
    'Financials': ['SAN.MC','BBVA.MC','CABK.MC','BKT.MC'],
    'Industrials': ['IBE.MC','ANA.MC','FER.MC','AENA.MC'],
    'Consumer Discretionary': ['ITX.MC','AMS.MC','MEL.MC','CLNX.MC'],
    'Energy': ['REP.MC','ENAG.MC','REE.MC','IBR.MC'],
    'Basic Materials': ['MTS.MC','CIE.MC','ACX.MC','TUB.MC'],
    'Health Care': ['GRF.MC','ROVI.MC','PHM.MC','FAES.MC'],
    'Consumer Staples': ['PRIVATE','VIS.MC','EBRO.MC','SIRO.MC'],
    'Real Estate': ['MRL.MC','COL.MC','COL.MC','LRE.MC'],
    'Telecommunication Services': ['TEF.MC','CLNX.MC','MAS.MC','EKT.MC'],
    'Utilities': ['IBE.MC','ELE.MC','NTGY.MC','ENAG.MC']
}
