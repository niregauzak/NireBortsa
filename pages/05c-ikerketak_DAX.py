...
sectors = {
    'Industrials': ['SIE.DE','LIN.DE','MTX.DE','RHM.DE'],
    'Health Care': ['FRE.DE','FME.DE','MRK.DE','QIA.DE'],
    'Consumer Discretionary': ['ADS.DE','BMW.DE','DAI.DE','VOW3.DE'],
    'Financials': ['ALV.DE','DBK.DE','CBK.DE','MUV2.DE'],
    'Consumer Staples': ['BEI.DE','HEN3.DE','SY1.DE','VNA.DE'],
    'Information Technology': ['SAP.DE','IFX.DE','WDI.DE','SHL.DE'],
    'Communication Services': ['DTE.DE','PSM.DE','RRTL.DE','UTDI.DE'],
    'Energy': ['RWE.DE','EOAN.DE','UN01.DE','EBK.DE'],
    'Materials': ['BAS.DE','1COV.DE','LXS.DE','WCH.DE'],
    'Real Estate': ['DWNI.DE','VNA.DE','LEG.DE','AT1.DE'],
    'Utilities': ['EOAN.DE','RWE.DE','UN01.DE','IGY.DE']
}
